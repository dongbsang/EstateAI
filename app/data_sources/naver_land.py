...
class NaverLandClient:
    ...
    REGION_COORDS = {
        ...
        # === 경기도 주요 도시 ===
        # 성남시
        "41131": {"lat": 37.4380, "lng": 127.1378, "name": "성남 수정구"},
        "41133": {"lat": 37.4321, "lng": 127.1193, "name": "성남 중원구"},
        "41135": {"lat": 37.3825, "lng": 127.1152, "name": "성남 분당구"},
        # 수원시
        "41111": {"lat": 37.3030, "lng": 127.0100, "name": "수원 장안구"},
        "41113": {"lat": 37.2574, "lng": 126.9716, "name": "수원 권선구"},
        "41115": {"lat": 37.2850, "lng": 127.0200, "name": "수원 팔달구"},
        "41117": {"lat": 37.2596, "lng": 127.0465, "name": "수원 영통구"},
        # 용인시
        "41461": {"lat": 37.2342, "lng": 127.2020, "name": "용인 처인구"},
        "41463": {"lat": 37.2800, "lng": 127.1150, "name": "용인 기흥구"},
        "41465": {"lat": 37.3220, "lng": 127.0980, "name": "용인 수지구"},
        # 고양시
        "41281": {"lat": 37.6376, "lng": 126.8320, "name": "고양 덕양구"},
        "41285": {"lat": 37.6586, "lng": 126.7742, "name": "고양 일산동구"},
        "41287": {"lat": 37.6759, "lng": 126.7511, "name": "고양 일산서구"},
        # 안양시
        "41171": {"lat": 37.3943, "lng": 126.9320, "name": "안양 만안구"},
        "41173": {"lat": 37.3897, "lng": 126.9533, "name": "안양 동안구"},
        # 부천시
        "41190": {"lat": 37.5034, "lng": 126.7660, "name": "부천시"},
        # 광명시
        "41210": {"lat": 37.4786, "lng": 126.8644, "name": "광명시"},
        # 안산시
        "41271": {"lat": 37.3180, "lng": 126.8468, "name": "안산 상록구"},
        "41273": {"lat": 37.3188, "lng": 126.8105, "name": "안산 단원구"},
        # 화성시
        "41590": {"lat": 37.1995, "lng": 127.0985, "name": "화성시"},
        # 평택시
        "41220": {"lat": 36.9908, "lng": 127.0858, "name": "평택시"},
        # 시흥시
        "41390": {"lat": 37.3800, "lng": 126.8028, "name": "시흥시"},
        # 김포시
        "41570": {"lat": 37.6152, "lng": 126.7156, "name": "김포시"},
        # 광주시 (경기)
        "41610": {"lat": 37.4095, "lng": 127.2550, "name": "경기광주시"},
        # 하남시
        "41450": {"lat": 37.5393, "lng": 127.2148, "name": "하남시"},
        # 구리시
        "41310": {"lat": 37.5943, "lng": 127.1295, "name": "구리시"},
        # 남양주시
        "41360": {"lat": 37.6360, "lng": 127.2165, "name": "남양주시"},
        # 의정부시
        "41150": {"lat": 37.7381, "lng": 127.0337, "name": "의정부시"},
        # 파주시
        "41480": {"lat": 37.7599, "lng": 126.7800, "name": "파주시"},
        # 과천시
        "41290": {"lat": 37.4292, "lng": 126.9876, "name": "과천시"},
        # 의왕시
        "41430": {"lat": 37.3449, "lng": 126.9685, "name": "의왕시"},
        # 군포시
        "41410": {"lat": 37.3617, "lng": 126.9352, "name": "군포시"},
    }
